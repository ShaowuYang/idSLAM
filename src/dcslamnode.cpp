...
class dcslamnode : public BasePTAMNode {
public:
    dcslamnode() :
        BasePTAMNode()
    {
        ...
        image_sub_ = it.subscribe(image_, 1, boost::bind(&dcslamnode::imageCallback, this, _1));

        image4ini_sub_ = it.subscribe("/simple_landing/image_ini_ptam", 1, boost::bind(&dcslamnode::image_ini_Callback, this, _1));
        sub_attitude_ = nh_.subscribe<pximu::AttitudeData>("/attitude", 1, boost::bind(&dcslamnode::attitudeCallback, this, _1));
        sub_pose_ekf_ = nh_.subscribe<geometry_msgs::PoseWithCovarianceStamped>("/ssf_core/pose_predicted_ekf", 1, boost::bind(&dcslamnode::pose_predicted_ekfCallback, this, _1));

        sub_pose_simplenode_ = nh_.subscribe<geometry_msgs::TransformStamped>("/simple_landing/vicon_pose_ptam", 1, boost::bind(&dcslamnode::viconCallback, this, _1));
