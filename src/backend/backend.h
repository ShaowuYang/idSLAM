...
public:
    ...
    bool relocaliseRegister(const boost::shared_ptr<ptam::KeyFrame> goodkf, const  boost::shared_ptr<ptam::KeyFrame> kf, Sophus::SE3d &result, double minInliers = .50); // register the relocalisation module for the front-end
