...
class DualMonoSLAMnode : public BasePTAMNode {
public:
    DualMonoSLAMnode() :
        BasePTAMNode()
    {
        ...
        if (!nh_private_.getParam("cam_sec_imu_file", cam_para_path_second))
            cam_para_path_second = "data/parameter_wrt_second.txt";
        ...
        image_sub_ = it.subscribe(image_, 1, boost::bind(&DualMonoSLAMnode::imageCallback, this, _1));

        image4ini_sub_ = it.subscribe("/simple_landing/image_ini_ptam", 1, boost::bind(&DualMonoSLAMnode::image_ini_Callback, this, _1));
        sub_attitude_ = nh_.subscribe<pximu::AttitudeData>("/attitude", 1, boost::bind(&DualMonoSLAMnode::attitudeCallback, this, _1));
        sub_pose_ekf_ = nh_.subscribe<geometry_msgs::PoseWithCovarianceStamped>("/ssf_core/pose_predicted_ekf", 1, boost::bind(&DualMonoSLAMnode::pose_predicted_ekfCallback, this, _1));

        sub_pose_simplenode_ = nh_.subscribe<geometry_msgs::TransformStamped>("/simple_landing/vicon_pose_ptam", 1, boost::bind(&DualMonoSLAMnode::viconCallback, this, _1));
...
//            cout << pose->pose.covariance[6] << ", " << pose->pose.covariance[7] << ", " << pose->pose.covariance[8] << endl;
            ...
            geometry_msgs::TransformStampedPtr quadpose;// for ros nodelets, publish ptr.
